...
class DiscordDisco(commands.Cog):
    ...
    async def play(self, ctx, url: str):
        ...
        try:
            ...
            await ctx.channel.send('ERROR: Audio playing')
            return
    ...
    async def pause(self, ctx):
        ...
        if voice and voice.is_playing():
            ...
            await ctx.channel.send('Audio not playing - failed pause')
    ...
    async def resume(self, ctx):
        ...
        if voice and voice.is_paused():
            print('Music paused')
            voice.resume()
            await ctx.channel.send('Resumed Audio')
        else:
    ...
    async def skip(self, ctx):
        ...
        if voice and voice.is_playing():
            print('Music skipped')
            voice.stop()
            await ctx.channel.send('Audio skipped')
        else:
            print('Music not playing - failed skipped')
            await ctx.channel.send('Audio not playing - failed skipped')
    ...
    async def queue(self, ctx, url: str):
        ...
        await ctx.channel.send('Adding Audio ' + str(q_num) + ' to the queue')
        print('Song Added')
